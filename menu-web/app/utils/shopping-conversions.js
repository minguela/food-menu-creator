...
export function convertToGrams({ name = "", quantity = 0, unitType = "g" }) {
  ...
  if (unit === "ml") {
    ...
    return density.known
      ? estimated(
          amount * density.gramsPerMl,
          `Densidad usada: ${density.gramsPerMl} g/ml.`,
        )
      : ambiguous(
          amount,
          "Densidad desconocida; se asume 1 g/ml hasta editar.",
        );
  }
  ...
  if (unit === "l") {
    ...
    return density.known
      ? estimated(
          amount * 1000 * density.gramsPerMl,
          `Densidad usada: ${density.gramsPerMl} g/ml.`,
        )
      : ambiguous(
          amount * 1000,
  ...
  if (unit === "cucharada" || unit === "tbsp") {
    ...
    return density.known
      ? estimated(
          ...
          "Convertido desde cucharadas.",
        )
      : ambiguous(
          amount * TABLESPOON_ML,
          "Cucharada ambigua; se asume 15 g hasta editar.",
        );
  }
  ...
  if (unit === "cucharadita" || unit === "tsp") {
    ...
    return density.known
      ? estimated(
          ...
          "Convertido desde cucharaditas.",
        )
      : ambiguous(
          amount * TEASPOON_ML,
          "Cucharadita ambigua; se asume 5 g hasta editar.",
        );
  }
